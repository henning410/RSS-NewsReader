...
var feeds = [
    {
        id: 'it-board',
        url: 'https://www.hs-esslingen.de/index.php?id=93917&type=101',
        dataType: 'jsonp',
    ...
    {
        id: 'it-news',
        url: 'https://www.hs-esslingen.de/index.php?id=93908&type=101',
        dataType: 'jsonp',
        displayName: 'IT-News',
        handler: loadJSONP
    },
    {
        id: 'hs-news',
        url: 'https://www.hs-esslingen.de/index.php?id=92976&type=101',
        dataType: 'jsonp',
        displayName: 'HS-News',
        handler: loadJSONP
    },
    {
        id: 'rz-news',
        url: 'https://www.hs-esslingen.de/index.php?id=93895&type=101',
        dataType: 'jsonp',
        displayName: 'RZ-News',
        handler: loadJSONP
    },
...
function fixDownloadsAndImages($content ){
    $content.find('a').each(function(index, element){
       ...
       if( $element.attr('href').indexOf('fileadmin') == 0 ) {
           $element.attr('href', 'http://www.hs-esslingen.de/' + $element.attr('href') );
       }
    });
    ...
    $content.find('img').each(function(index, element){
        ...
        if( ~$element.attr('src').indexOf('..') ){
            ...
            if( ~$fileadminIndex ) {
                $element.attr('src', 'http://www.hs-esslingen.de/' + $element.attr('src').substr($fileadminIndex));
            } else {
                $element.remove();
            }
        }
